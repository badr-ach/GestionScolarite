...
(
	IN id_n int,
    IN code_elv varchar(100),
    IN code_matiere varchar(100),
    IN note decimal(9,2)
)
BEGIN
    Update notes set note=note where code_eleve=code_elv and code_mat=code_matiere and id=id_n;
END|
...
BEGIN
    Delete from notes where id = id_n;
END|
